...
def train_att(train_loader, model, criterion, optimizer, epoch, cycle_scheduler):
    ...
    y_tru = None
    y_p = None
    for i, (images, images2, target) in enumerate(train_loader):
        # measure data loading time
...
def validate_att(val_loader, model, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (images, img2, target) in enumerate(val_loader):
